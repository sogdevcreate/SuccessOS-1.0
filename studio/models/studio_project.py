...
from studio.post_production.render_result import RenderResult
from studio.publishing.publish_request import PublishRequest
from studio.publishing.publish_result import PublishResult
...
class StudioProject:
    ...
    learning_reports: list[LearningReport] = field(default_factory=list)
    learning_recommendations: list[LearningRecommendation] = field(default_factory=list)
    optimization_policies: list[OptimizationPolicy] = field(default_factory=list)
